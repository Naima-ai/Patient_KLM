...
The KLM currently contains two patients across two demos:
Demo 1 — P-001 (Nephrology)
A patient with renal cell carcinoma and post-nephrectomy CKD. EHR visit records and full genomic profile were synthetically generated by Claude to simulate a real clinical scenario.
Demo 2 — PT-8839-CR (Hypertension + CKD + Cardiology)
A patient with essential hypertension, Chronic Kidney Disease Stage 2, and cardiovascular risk factors. Data is split across four domain-specific KLM files: DNA/EHR, nephrology, cardiology, and hypertension. 
